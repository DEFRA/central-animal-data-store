...
public class ExceptionHandlingMiddlewareTests
{
    ...
    private HttpContext CreateHttpContext(string path = "/test", string? traceHeaderValue = null)
    {
    ...
    public async Task FluentValidationException_returns_422_with_structured_errors()
    {
        var validationFailures = new List<ValidationFailure>
        {
            ...
            new ValidationFailure("CPH", "'CPH' is not valid."),
        };
    ...
    {
        var context = CreateHttpContext();
        var middleware = CreateMiddleware(_ => throw new PermissionDeniedException("Access denied"));
    ...
    {
        var context = CreateHttpContext();
        var middleware = CreateMiddleware(_ => throw new ConflictException("Resource conflict"));
