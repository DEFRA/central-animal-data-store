using CentralAnimalDataStore.Example.Endpoints;
using CentralAnimalDataStore.Example.Services;
using CentralAnimalDataStore.Utils;
using CentralAnimalDataStore.Utils.Http;
using CentralAnimalDataStore.Utils.Mongo;
using FluentValidation;
using System.Diagnostics.CodeAnalysis;
using CentralAnimalDataStore.Config;
using CentralAnimalDataStore.Utils.Logging;
using Serilog;
